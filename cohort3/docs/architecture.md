...
# Why to use useMemo
In the code generated by the AI, it was found the usages of useMemo. Explain all the relevant topics and details of useMemo. 
Also include the examples too , explaining the use cases for this purpose